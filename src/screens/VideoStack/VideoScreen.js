...
import { addListPostVideoEnd, selectVideoPost, setListVideoPost } from '../../redux/features/post/postSlice';
...
function VideoScreen({ route, navigation }) {
    ...
    const post = useSelector(selectVideoPost);
            ...
            .then((response) => {
                if (response.data.code === '1000') {
                    if (response.data.data.post?.length !== 0 && response.data.data?.last_id !== pagination.lastId) {
                        ...
                        dispatch(addListPostVideoEnd(response.data.data.post));
                    } else {
            ...
            .then((response) => {
                if (response.data.code === '1000') {
                    if (response.data.data.post.length !== 0 && response.data.data.last_id !== pagination.lastId) {
                        ...
                        dispatch(setListVideoPost(response.data.data.post));
                        setPagination({
                            ...pagination,
                            lastId: response.data.data.last_id,
