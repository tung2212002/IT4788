...
import Svg, { RadialGradient, Stop, LinearGradient, G, Circle, Path } from 'react-native-svg';
/* SVGR has dropped some elements not supported by react-native-svg: filter */

function EmojiHaha() {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" height={40} width={40} viewBox="0 0 192 192">
            ...
            <RadialGradient id="prefix__b" cy="100%" gradientTransform="matrix(0 -1 1.136 0 -.636 1.5)" r="100%">
                <Stop offset={0} stopColor="#83370e" />
                <Stop offset={0.226} stopColor="#83370e" />
                <Stop offset={1} stopColor="#482213" />
            </RadialGradient>
            <RadialGradient id="prefix__c" cy="0%" gradientTransform="matrix(0 1 -.7355 0 .5 -.5)" r="100%">
            ...
            <G fill="none" fillRule="evenodd">
                ...
                <Path d="M96 166c38.66 0 64-31.34 64-70 0-.66-7-13-64-13S32 95.34 32 96c0 38.66 25.34 70 64 70z" fill="url(#prefix__b)" />
                <Path
