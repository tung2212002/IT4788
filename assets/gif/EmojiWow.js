...
import Svg, { Defs, LinearGradient, Stop, RadialGradient, Ellipse, G, Circle, Path, Use } from 'react-native-svg';
...
function EmojiWow() {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" height={40} width={40} viewBox="0 0 192 192">
            <Defs>
                <LinearGradient id="prefix__c" x1="10.909%" x2="85.942%" y1="55.621%" y2="50%">
                ...
                <RadialGradient id="prefix__f" cx="47.795%" cy="72.401%" gradientTransform="matrix(-.13245 .79295 -.76649 -.08194 1.096 .404)" r="98.416%">
            ...
            <G fill="none" fillRule="evenodd">
                ...
                <Path
                    ...
                    opacity={0.449}
                />
                <Path d="M97 172c22.06-.667 28-16.118 28-36 0-17.882-10.536-36-28-36s-28 18.118-28 36c0 18.882 5.94 36.667 28 36z" fill="url(#prefix__l)" />
            </G>
        </Svg>
    );
}
