...
function EmojiAngry() {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" width={40} height={40} fill="none" viewBox="0 0 16 16">
            <Path fill="url(#prefix__paint0_linear)" d="M16 8A8 8 0 11-.001 8 8 8 0 0116 8" />
            <Path
                fill="#000"
            ...
            />
            <Defs>
                <LinearGradient id="prefix__paint0_linear" x1={8} x2={8} y2={10.751} gradientUnits="userSpaceOnUse">
                    <Stop stopColor="#E04300" />
                    <Stop offset={1} stopColor="#FFA320" />
                </LinearGradient>
                <LinearGradient id="prefix__paint1_linear" x1={8} x2={8} y1={12.703} y2={14} gradientUnits="userSpaceOnUse">
                    <Stop stopColor="#3D0D00" />
                    <Stop offset={1} stopColor="#661C04" />
                </LinearGradient>
                <LinearGradient id="prefix__paint2_linear" x1={8} x2={8} y1={8.4} y2={11} gradientUnits="userSpaceOnUse">
                    <Stop stopColor="#191A33" />
                    <Stop offset={0.872} stopColor="#3B426A" />
                </LinearGradient>
                <LinearGradient id="prefix__paint3_linear" x1={11.615} x2={11.615} y1={9.333} y2={7} gradientUnits="userSpaceOnUse">
