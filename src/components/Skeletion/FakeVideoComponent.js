...
const videoHeight = Dimensions.get('window').height * 0.6;
    ...
    return (
        <Container>
            <Card>
                ...
                <CardBody>
                    <SkeletonComponent width={skeWidth} height={videoHeight} style={{ marginTop: 4, borderRadius: 4 }} />
                </CardBody>
            </Card>
        </Container>
    );
...
export default FakeVideoComponent;
