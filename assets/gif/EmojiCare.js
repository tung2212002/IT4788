...
import Svg, { LinearGradient, Stop, Path, RadialGradient, Defs, Mask } from 'react-native-svg';
/* SVGR has dropped some elements not supported by react-native-svg: filter */

function EmojiCare() {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" enableBackground="new 0 0 16 16" viewBox="0 0 16 16" width={40} height={40}>
            <LinearGradient
                id="prefix__a"
                x1={-2.313}
                x2={-2.313}
            ...
            <Path fill="url(#prefix__a)" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" />
            <RadialGradient id="prefix__b" cx={-2.313} cy={20.313} r={0.5} gradientTransform="matrix(16 0 0 -16 45 333)" gradientUnits="userSpaceOnUse">
                <Stop offset={0} stopColor="#f28a2d" stopOpacity={0} />
                <Stop offset={1} stopColor="#f08423" stopOpacity={0.34} />
            </RadialGradient>
            <Path fill="url(#prefix__b)" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__c"
                cx={-2.644}
                cy={20.358}
            ...
            <Path fill="url(#prefix__c)" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__d"
                cx={-2.227}
                cy={19.541}
            ...
            <Path fill="url(#prefix__d)" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__e"
                cx={-2.531}
                cy={19.776}
            ...
            <Path fill="url(#prefix__e)" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__f"
                cx={-2.098}
                cy={20.131}
            ...
            <Path fill="url(#prefix__f)" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" />
            <LinearGradient
                id="prefix__g"
                x1={-1.619}
                x2={-1.619}
            ...
            <Path fill="url(#prefix__g)" fillRule="evenodd" d="M9.7 5.9c-.1-.3-3.3-.3-3.4 0-.1.3.6.7 1.7.7s1.8-.4 1.7-.7z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__h"
                cx={-3.9}
                cy={18.924}
            ...
            <Path fill="url(#prefix__h)" fillRule="evenodd" d="M6 4.1c0 .7-.4.9-1 1-.6.1-1.1-.2-1.1-1 0-.6.3-1.4 1.1-1.4.7 0 1 .8 1 1.4z" clipRule="evenodd" />
            <Path fill="#4e506a" fillRule="evenodd" d="M4.9 3.1c.1.1.1.4-.1.5-.1.1-.3.2-.4 0s-.1-.3 0-.5c.2-.1.4-.1.5 0z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__i"
                cx={-3.914}
                cy={18.924}
            ...
            <Path
                ...
                clipRule="evenodd"
            />
            <Path fill="#4e506a" fillRule="evenodd" d="M11 3.1c.1.1 0 .3-.1.5-.1.1-.3.1-.4 0s0-.3.1-.5c.2-.2.3-.2.4 0z" clipRule="evenodd" />
            <RadialGradient
                id="prefix__j"
                cx={-5.202}
                cy={20.231}
            ...
            />
            <Defs></Defs>
            <Mask id="prefix__u" width={6.9} height={5.4} x={-0.2} y={7.2} maskUnits="userSpaceOnUse">
                <Path fill="#fff" fillRule="evenodd" d="M16 8c0 4.4-3.6 8-8 8s-8-3.6-8-8 3.6-8 8-8 8 3.6 8 8z" clipRule="evenodd" filter="url(#prefix__s)" />
            </Mask>
            <RadialGradient
                id="prefix__t"
                cx={-2.204}
            ...
            <Path
                ...
                mask="url(#prefix__u)"
            />
            <RadialGradient id="prefix__v" cx={15.654} cy={7.737} r={8.846} gradientUnits="userSpaceOnUse">
                <Stop offset={0} stopColor="#eda83a" />
                <Stop offset={1} stopColor="#ffdc5e" />
            </RadialGradient>
            <Path
