...
function EmojiLike() {
    return (
        <Svg xmlns="http://www.w3.org/2000/svg" height={40} width={40} viewBox="-9.31 -9.31 200.6 200.599">
            <LinearGradient id="prefix__a" x1="47.061%" x2="47.061%" y1="-3.394%" y2="96.606%">
